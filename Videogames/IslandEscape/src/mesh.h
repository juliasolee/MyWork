...
public:
	...
	void createQuadGUI(float center_x, float center_y, float w, float h, float uv_x1, float uv_y1, float uv_x2, float uv_y2, float image_size, bool flip_uvs);
	void createQuad_U_R(Vector3 pos, Vector3 R, Vector3 U);
